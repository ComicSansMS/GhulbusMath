#ifndef GHULBUS_LIBRARY_INCLUDE_GUARD_MATH_GHULBUS_MATH_HPP
#define GHULBUS_LIBRARY_INCLUDE_GUARD_MATH_GHULBUS_MATH_HPP

/** @file
*
* @brief Convenience header including all headers from the library.
