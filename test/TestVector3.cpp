...
TEST_CASE("Vector3")
{
    ...
    {
        static_assert(std::same_as<Vector3<float>::ValueType, float>);
        static_assert(std::same_as<Vector3<int>::ValueType, int>);
        static_assert(std::same_as<Vector3<double>::ValueType, double>);
    }
