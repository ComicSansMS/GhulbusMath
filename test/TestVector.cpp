...
TEST_CASE("Vector")
{
    ...
    {
        CHECK(lerp(Vector<float, 6>(0.f, 0.f, 0.f, 0.f, 0.f, 0.f),
            Vector<float, 6>(1.f, 2.f, 3.f, 4.f, 5.f, 6.f), 0.5f) ==
            Vector<float, 6>(0.5f, 1.f, 1.5f, 2.f, 2.5f, 3.f));
        CHECK(lerp(Vector<float, 6>(5.f, 2.f, 9.f, 16.f, 1.f, -2.f),
            Vector<float, 6>(1.f, 2.f, 3.f, 4.f, 5.f, 6.f), 0.25f) ==
            Vector<float, 6>(4.f, 2.f, 7.5f, 13.f, 2.f, 0.f));
    }
